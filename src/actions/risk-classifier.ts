...
export function classifyActionRisk(actionType: ActionType, payload: Record<string, unknown> = {}): "low" | "medium" | "high" {
  ...
  if (actionType === "draft_email" || actionType === "draft_followup_message" || actionType === "outbound_email_review") return "medium";
...
export function isExternalConnectorAction(actionType: ActionType): boolean {
  return actionType === "draft_email" || actionType === "draft_followup_message" || actionType === "outbound_email_review" || actionType === "propose_calendar_event";
}
